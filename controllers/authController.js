...
const generateActivationToken = (payload) => {
  return jwt.sign(payload, process.env.JWT_SECRET, {
    expiresIn: process.env.JWT_EXPIRES_IN_ACTIVATION,
  });
};
...
const createSendToken = (user, statusCode, req, res, refreshTokens) => {
...
exports.signup = catchAsync(async (req, res, next) => {
  const newUser = await User.create({
    ...
    photo: "public/img/users/avatarDefault.png",
  ...
  createSendToken(newUser, 201, req, res, refreshTokens);
});
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  createSendToken(user, 200, req, res, refreshTokens);
});
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    const url = `${process.env.CLIENT_URL}/api/v1/users/resetPassword/${resetToken}`;
